                ...
                <div className="grid gap-y-3">
                    <div className="flex gap-x-2">
                        ...
                        <label className="flex-1 relative group block cursor-pointer">
                            ...
                            text-sm text-gray-500 transition-all peer-focus:h-7 peer-focus:text-primary-brand-color peer-focus:text-xs peer-valid:h-7 peer-valid:text-primary-brand-color peer-valid:text-xs">Telefon Numarası</span>
                        </label>
                    </div>
